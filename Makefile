...
LIBS += drivers/cnc1800l/cncedid/libedid.o
endif
...
ifeq ($(SECURE),1)
		cat hdmi_pic_bin $(CNC_PLATFORM)/bootloader/apps/cuid/cuid.bin $(CNC_PLATFORM)/bootloader/apps/dvu/dvu.bin >> $@
else
		cat hdmi_pic_bin cuid_pic_bin dvu_pic_bin>> $@
endif
		$(BOARD_SIZE_CHECK)
