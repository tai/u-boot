...
#if (CONFIG_TARGET_NAME == CNC1800L_OTT)
	/* 1800L_OTT doesn't support boots, esp1800l_flash_util and upgrade commands */
#else
	#define CONFIG_CMD_BOOTS
	#define CONFIG_CMD_ESP1800L_FLASH_UTIL
...
#define CONFIG_ENV_SECT_IN_NAND_OFFSET 0x120000 /* environment starts here in nand flash*/
#define CONFIG_ENV_SECT_SIZE     0x00020000 /* 128 KB sectors                                                      */
  ...
  #define CONFIG_ENV_SIZE          0x00002000     /* Total Size of Environment Sector 8KB */
  #define CONFIG_ENV_OFFSET        0x000E000      /* environment starts here              */
  #define CONFIG_ENV_SECT_IN_NAND_OFFSET 0x880000 /* environment starts here in nand flash*/
  #define CONFIG_ENV_SECT_SIZE     0x00002000     /* 8KB sectors                          */
#elif (CONFIG_TARGET_NAME == CNC1800L_TMS_128)
  #define CONFIG_ENV_IS_IN_SPI_FLASH
  #define CONFIG_ENV_SIZE          0x00002000     /* Total Size of Environment Sector 8KB */
  #define CONFIG_ENV_OFFSET        0x000c000      /* environment starts here              */
  #define CONFIG_ENV_SECT_IN_NAND_OFFSET 0x120000 /* environment starts here in nand flash*/
  #define CONFIG_ENV_SECT_SIZE     0x00002000     /* 8KB sectors                          */
  /* no Ethernet on TMS128 board */
  ...
  #define CONFIG_ENV_SIZE          0x00002000     /* Total Size of Environment Sector 8KB */
  #define CONFIG_ENV_OFFSET        0x0180000      /* environment starts here              */
  #define CONFIG_ENV_SECT_IN_NAND_OFFSET 0x120000 /* environment starts here in nand flash*/
  #define CONFIG_ENV_SECT_SIZE     0x00002000     /* 8KB sectors                          */
  /* no Ethernet on TMS128 board */
  #undef CONFIG_NET_MULTI
...
#define GFXBASEADDRESS		0xc000000
...
#define CONFIG_ALIGNED_PIC_PROC_MEM_SIZE CONFIG_UBOOT_EXTERNAL_PROC_LEN
