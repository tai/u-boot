...
#define READ_TIMER()  (0 - orion_apb_read32(CONFIG_SYS_TIMERBASE+4))
...
int timer_init (void)
{
	orion_apb_write32((CONFIG_SYS_TIMERBASE + 0), CONFIG_SYS_TIMER_RELOAD);	/* TimerLoad */
	orion_apb_write32((CONFIG_SYS_TIMERBASE + 4), CONFIG_SYS_TIMER_RELOAD);	/* TimerValue */
	orion_apb_write32((CONFIG_SYS_TIMERBASE + 8), 0x1);
